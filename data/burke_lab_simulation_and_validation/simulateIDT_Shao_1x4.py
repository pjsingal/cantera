...
for k, m in enumerate(models):
    ...
    if m=="LMR-R":
        ...
        ax[0].semilogy(T_list, 1e6*ignitionDelays_RG, '-', linestyle='solid', linewidth=lw, color=colors[k], label='_nolegend_')
    
ax[0].semilogy(T_df,IDT_df,'o',fillstyle='none',linestyle='none',color='k',markersize=msz,markeredgewidth=mw,label='_nolegend_')#,label='Shao et al.')
...
for k, m in enumerate(models):
    ...
    if m=="Ar":
        ...
        ax[1].semilogy(T_list, 1e6*ignitionDelays_RG, '-', linestyle='solid',linewidth=lw, color=colors[k], label='_nolegend_')
    
ax[1].semilogy(T_df,IDT_df,'o',fillstyle='none',linestyle='none',color='k',markersize=msz,markeredgewidth=mw,label='_nolegend_')#,label='Shao et al.')
...
for k, m in enumerate(models):
    ...
    if m==r'H$_2$O':
        ...
        ax[2].semilogy(T_list, 1e6*ignitionDelays_RG, '-', linestyle='solid',linewidth=lw, color=colors[k], label='_nolegend_')
ax[2].semilogy(T_df,IDT_df,'o',fillstyle='none',linestyle='none',color='k',markersize=msz,markeredgewidth=mw,label='_nolegend_')#,label='Shao et al.')
...
for k, m in enumerate(models):
    ...
    for j, T in enumerate(T_list):
        ...
        t1 = time.time()
        ignitionDelays_RG[j] = tau
    ax[3].semilogy(T_list, 1e6*ignitionDelays_RG, '-', linestyle='solid',linewidth=lw, color=colors[k], label='_nolegend_')
