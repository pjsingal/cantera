...
# # --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz $lgdfsz --gridsz 9 &
...
# --figwidth 4.5 --figheight 2.5 --fsz $fsz --fszxtick $fszxtick --fszytick $fszytick --fszaxlab $fszaxlab \
...
# python burkelab_SimScripts/simulateflamespeedBurke.py --gridsz 40 --date 'May31' --slopeVal 0.01 --curveVal 0.01 --transport 'multicomponent'
...
# --figwidth 3.5 --figheight 2.72222 --fsz $fsz --fszxtick $fszxtick --fszytick $fszytick --fszaxlab $fszaxlab \
# --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz $lgdfsz --date 'May28' --slopeVal 0.01 --curveVal 0.01 --title 'Burke/Song (slope=0.01 curve=0.01)' &

python burkelab_SimScripts/simulateflamespeedRonney_0.6NH3_0.4H2_FromData.py \
--figwidth 6.5 --figheight 2.72 --fsz 5 --fszxtick $fszxtick --fszytick $fszytick --fszaxlab $fszaxlab \
--lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz $lgdfsz --date 'May31' --slopeVal 0.05 --curveVal 0.05 --paper 'ESSCI' &

python burkelab_SimScripts/simulateflamespeedRonney_0.6NH3_0.4H2_FromData.py \
--figwidth 3.5 --figheight 4.5 --fsz 5 --fszxtick $fszxtick --fszytick $fszytick --fszaxlab $fszaxlab \
--lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz $lgdfsz --date 'May31' --slopeVal 0.05 --curveVal 0.05 --paper 'PCI' &
...
# --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz $lgdfsz &
