...
# --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz 7 --gridsz 10 &
...
# --figwidth 6 --figheight 1.66667 --fsz $fsz --fszxtick $fszxtick --fszytick $fszytick --fszaxlab $fszaxlab \
# --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz 5 --gridsz 70 &
...
# --lw $lw --mw $mw --msz $msz --lgdw $lgdw --lgdfsz 7 --gridsz 70 &
...
# --lw $lw --mw $mw --msz 2.5 --lgdw $lgdw --lgdfsz $lgdfsz --gridsz 10 &
