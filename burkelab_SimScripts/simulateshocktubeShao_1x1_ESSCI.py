...
plotXvsTime("test\\data\\alzuetamechanism_epsNH3_T=300K.yaml",r"$\epsilon_{0,NH_3}(300K)$","xkcd:teal",zorder_value=82)
plotXvsTime("test\\data\\alzuetamechanism_epsNH3_T=2000K.yaml",r"$\epsilon_{0,NH_3}(2000K)$","orange",zorder_value=81)
